...
const Footer = () => {
  document.addEventListener('contextmenu', event => event.preventDefault());
  return (
    <div className='select-none h-[400px] w-full flex flex-col items-center justify-center bg-zinc-900 gap-5'>
      ...
      <div className='text-[#909090]  al text-md sm:text-l flex flex-col items-center justify-center gap-5 '>
        {/* <p >@ 2022 Grustl.</p> */}
        <p className='text-[15px] text-center '>Experience the power of transformative branding with Grustl, one of world's leading branding agency. Our team of experts will work with you to craft a unique and impactful brand identity that resonates <br></br> with  your audience and drives business growth.Take the first step towards elevating your brand and join us in creating meaningful change.</p>
        ...
        <span class="w-full border-t border-zinc-700 rounded lg:w-5/6"></span>
        <div className='flex flex-row gap-2 duration-700'>
